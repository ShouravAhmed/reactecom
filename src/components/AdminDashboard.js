  ...
  return (
    <div className="admin-panel-container">
      ...
      <div className="card-container">
        ...
        <div className="card" onClick={() => navigate('product-management')}>
          <i className="icon fa fa-shopping-bag" aria-hidden="true"></i>
          <p>Product Management</p>
        </div>

        <div className="card" onClick={() => navigate('order-management')}>
          <i className="icon fa fa-shopping-cart" aria-hidden="true"></i>
          <p>Order Management</p>
        </div>

        <div className="card" onClick={() => navigate('user-management')}>
          <i className="icon fa fa-users" aria-hidden="true"></i>
          <p>User Management</p>
        </div>

        <div className="card" onClick={() => navigate('accounce-management')}>
