...
function DeliveryDetails() {            
  ...
  useEffect(() => {
    ...
    console.log("=>> delivery: local deliveryDetails: ", localDeliveryDetails);
  ...
  useEffect(() => {
    console.log("=>> delivery: deliveryDetails: ", deliveryDetails);
    const localDeliveryDetails = JSON.parse(localStorage.getItem('LOCAL_DELIVERY_DETAILS'));
    if (JSON.stringify(deliveryDetails) !== JSON.stringify(localDeliveryDetails) && deliveryDetailsInitiated) 
    {
      localStorage.setItem('LOCAL_DELIVERY_DETAILS', JSON.stringify(deliveryDetails));
    }
  }, [deliveryDetails]);



  console.log("delivery details page is being loaded");
